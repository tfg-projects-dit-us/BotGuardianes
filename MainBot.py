...
if __name__ == '__main__':
    ...
    dispatcher.add_handler(callback_handler)
    callback_handler=CallbackQueryHandler(telegram_tools.retorno_propuesta,pattern="hacer_propuesta")
    dispatcher.add_handler(callback_handler)
    callback_handler=CallbackQueryHandler(telegram_tools.retorno_propuesta_deshacer,pattern="deshacer_propuesta")
    dispatcher.add_handler(callback_handler)
    callback_handler=CallbackQueryHandler(telegram_tools.retorno_propuesta_enviar,pattern="enviar_propuesta")
    dispatcher.add_handler(callback_handler)
    callback_handler=CallbackQueryHandler(telegram_tools.retorno_aceptar_propuesta,pattern="aceptar_propuesta")
    dispatcher.add_handler(callback_handler)
    ...
    dispatcher.add_handler(callback_handler)
    callback_handler=CallbackQueryHandler(telegram_tools.retorno_cancelar_intercambio, pattern="cancelar_intercambio")
    dispatcher.add_handler(callback_handler)
